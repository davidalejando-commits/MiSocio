      ...
      <ScrollView style={styles.scroll} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.header}>
          <View style={styles.headerLeft}>
            <View style={styles.avatar}>
              <Ionicons name="person" size={20} color="#1A56FF" />
            </View>
            <Text style={styles.headerTitle}>Mi Negocio</Text>
          </View>
          <TouchableOpacity>
            <Ionicons name="search" size={24} color="#1A56FF" />
          </TouchableOpacity>
        </View>
        ...
        <View style={styles.cardCobros}>
          <View style={styles.cardCobrosTop}>
            <View>
              ...
              <Text style={styles.cardCobrosMonto}>
                $
                {cobrosPendientes.toLocaleString("es-CO", {
          ...
          <View style={styles.progressBar}>
            <View
              style={[
                styles.progressFill,
                { width: cobrosPendientes > 0 ? "55%" : "0%" },
              ]}
            />
          </View>
          <Text style={styles.cardCobrosSubtitle}>
            {clientesDeuda} {clientesDeuda === 1 ? "cliente" : "clientes"} con
            deuda activa
          </Text>
        </View>
        ...
        <View style={styles.accionesRow}>
          ...
          >
            ...
            <Text style={[styles.accionLabel, { color: "#2D6A00" }]}>
              Nueva Venta
            </Text>
          </TouchableOpacity>
          ...
          <TouchableOpacity
            ...
            onPress={() =>
              navigation.navigate("Clients", { screen: "NuevoCliente" })
            }
          >
            <View style={styles.accionIconWrap}>
              <Ionicons name="person-add" size={28} color="#1A56FF" />
            </View>
            <Text style={[styles.accionLabel, { color: "#1A56FF" }]}>
              Registrar{"\n"}Cliente
            </Text>
          </TouchableOpacity>
          ...
          <TouchableOpacity
            ...
            onPress={() =>
              navigation.navigate("Inventory", { screen: "NuevoProducto" })
            }
          >
            <View style={styles.accionIconWrap}>
              <Ionicons name="archive" size={28} color="#C05A00" />
            </View>
            <Text style={[styles.accionLabel, { color: "#C05A00" }]}>
              Añadir{"\n"}Producto
            </Text>
          </TouchableOpacity>
        </View>
...
const styles = StyleSheet.create({
  ...
  headerTitle: { fontSize: 20, fontWeight: "700", color: "#1A56FF" },
